...
class SharedController extends BaseController{
	...
	function barang_Id_Kategori_option_list(){
		$db = $this->GetModel();
		$sqltext = "SELECT DISTINCT Id_Kategori AS value , Kategori AS label FROM kategori ORDER BY label ASC";
		$queryparams = null;
	...
	/**
     * peminjaman_Id_Barang_option_list Model Action
     * @return array
     */
	function peminjaman_Id_Barang_option_list(){
		$db = $this->GetModel();
		$sqltext = "SELECT Id_Barang AS value , Nama_Barang , Merek , Jumlah_Aset FROM barang ORDER BY Nama_Barang ASC";
		$queryparams = null;
		$arr = $db->rawQuery($sqltext, $queryparams);
		return $arr;
	}
	...
	/**
     * peminjaman_cek_barang Model Action
     * @return array
     */
	// function peminjaman_cek_barang($id){
	// 	$db = $this->GetModel();
	// 	$db->where("barang.Id_Barang", $id);; //select record based on primary key
	// 	$sqltext = "SELECT COUNT(Id_Barang) FROM barang WHERE Id_Barang = $id";
	// 	$queryparams = null;
	// 	$arr = $db->rawQuery($sqltext, $queryparams);
	// 	return $arr;
	// }
	...
	function peminjaman_cek_barang($id){
		$db = $this->GetModel();
		$sqltext = "SELECT COUNT(*) AS num FROM barang WHERE Id_Barang = $id";
		$queryparams = null;
