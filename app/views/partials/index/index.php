                    ...
                    <div class="col-md-8 comp-grid">
                        <div class="">
                            <div class="fadeIn animated mb-4">
                                ...
                                <div class=""><div><center><img src="assets/images/pmi123.png" width="150" height="160" /></center></div>
                        <div><br>
                        Dibalik persaudaraan kita di Indonesia, ada relawan yang tak kenal pamrih menjaga setiap tetesan darah merah. Itulah PMI, penyelamat darah NKRI.
</div>
                    </div>
                                    ...
                                    <div class="form-group text-center">
                                        <button class="btn btn-primary btn-block btn-md" type="submit"> 
                                            <i class="load-indicator">
                                                <clip-loader :loading="loading" color="#FF0000" size="20px"></clip-loader> 
                                            </i>
