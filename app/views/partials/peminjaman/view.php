...
$can_kembalikan = ACL::is_allowed("peminjaman/kembalikan");
?>
<?php
                    ...
                    <div class="card animated fadeIn page-content">
                        ...
                        ?>
                            <div id="page-report-body" class="">
                                <table class="table table-hover table-borderless table-striped">
                                    ...
                                    <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        <tr class="td-Id_Peminjaman">
                                            <th class="title"> Id Peminjaman: </th>
                                            <td class="value"> <?php echo $data['Id_Peminjaman']; ?></td>
                                        </tr>
                                        <tr class="td-Id_Barang">
                                            ...
                                            <td class="value">
                                                <a size="sm" class="btn btn-sm btn-primary page-modal" href="<?php print_link("barang/view/" . urlencode($data['Id_Barang'])) ?>">
                                                    <i class="fa fa-eye"></i> Nama: <?php echo $data['barang_Nama_Barang']; ?> - Merek: <?php echo $data['barang_Merek']; ?>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr class="td-Id_User">
                                            <th class="title">Peminjam: </th>
                                            <td class="value">
                            ...
                            <div class="p-3 d-flex">
                                ...
                                <?php } ?>
                                <?php if ($can_kembalikan) { ?>
                                <a class="btn btn-sm btn-primary" href="<?php print_link("peminjaman/kembalikan/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>">
                                    <i class="fa fa-undo"></i> Kembalikan Barang
                                </a>
                                <?php } ?>
                            </div>
                        <?php
