...
$penyimpanan = "uploads/files/";
$isi = $data['Id_Barang']; 

QRcode::png($isi, $penyimpanan."qr-barang-". $data['Id_Barang'] .".png", QR_ECLEVEL_L, 4);
?>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr>
                                        <th class="title">QR Code: </th>
                                        <th class="value">
                                            <?php
                                                $qr_link = get_link($penyimpanan . 'qr-barang-' . $data['Id_Barang'] . '.png');
                                                Html :: page_img($qr_link,300,300);
                                            ?>
                                        </th>
                                    </tr>
                                </tbody>
